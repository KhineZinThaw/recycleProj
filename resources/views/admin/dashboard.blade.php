      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/admin-googlemaps') }}">
            ...
            <li class="nav-item nav-dropdown">
              ...
              <ul class="nav-dropdown-items">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ url('/admin-500') }}" target="_top">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{asset('admin/img/avatars/1.jpg')}}" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
