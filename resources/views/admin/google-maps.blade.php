...
<html lang="en">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/google-maps') }}">
            ...
            <li class="nav-item nav-dropdown">
              ...
              <ul class="nav-dropdown-items">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ url('/admin-datatables') }}">
            ...
            <li class="nav-item nav-dropdown">
              ...
              <ul class="nav-dropdown-items">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ url('/admin-404') }}" target="_top">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-header-actions">
                  <a class="card-header-action" href="https://google-developers.appspot.com/maps/documentation/javascript/reference" target="_blank">
    ...
    <script src="{{asset('admin/https://maps.googleapis.com/maps/api/js?callback=InitMap&amp;key=AIzaSyASyYRBZmULmrmw_P9kgr7_266OhFNinPA')}}"></script>
  </body>
</html>
